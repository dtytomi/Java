...
public class ArrayManipulations {
	...
	public static void main(String[] args) {
		...
		System.out.printf("intArray %s filledInArray\n", 
			( b ? "==" : "!=" ));

		// search intArray for the alue 5
	...
	public static void displayArray( int[] array, String desription )
	{
		System.out.printf("\n%s: ", desription );
